...
// O defeito de 11/09/2026: a cam_lateral2 corre 0,04% à frente do relógio real,
...
func TestTimelineSegueRelogioSemPerderQuadro(t *testing.T) {
	for _, tt := range []struct {
		...
		{"câmera no ritmo", 0},
		{"câmera adiantada 0,04%, a cam_lateral2", 0.0004},
		{"câmera atrasada 0,04%", -0.0004},
		{"câmera adiantada 0,08%, o dobro da cam_lateral2", 0.0008},
	} {
		t.Run(tt.nome, func(t *testing.T) {
