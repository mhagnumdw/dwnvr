...
// Uso:
//
//	spike -go2rtc http://servidor.local:1984 -cams cam_gama,cam_eta -out ./rec -seg 60 -dur 300
package main
...
func main() {
	var (
		...
		cams    = flag.String("cams", "cam_gama", "streams do go2rtc, separados por vírgula")
