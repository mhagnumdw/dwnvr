...
Descoberto em 08/08/2026 ao trocar a `cam_iota` de `onvif1` (1080p) para
...
O `Gen` do índice é o hash do init. Para H264 isso funciona: a `cam_epsilon`
...
`cam_iota` manteve `4edbc50d8e70` ao mudar de 1080p para 640x360.
